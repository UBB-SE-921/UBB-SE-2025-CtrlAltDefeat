...
namespace ArtAttack.Repository
{
    ...
    public class TrackedOrderRepository : ITrackedOrderRepository
    {
        ...
        public TrackedOrderRepository(string connectionString)
        ...
        public TrackedOrderRepository(string connectionString, IDatabaseProvider databaseProvider)
        {
        ...
        /// <summary>
        /// Helper method to add parameters to a command, handling null values.
        /// </summary>
        ...
        private void AddParameter(IDbCommand command, string parameterName, object? value)
        {
            ...
            parameter.Value = value ?? DBNull.Value; // Use DBNull.Value for null
